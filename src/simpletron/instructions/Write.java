...
/**
 * This object performs write operations within in the standard SML output
 * @author gerry dreamer
 */
public class Write extends Instructions{
     /**
     ...
     */
    public Write(OperationCodeRegister opCode, OperandRegister operand,Memory memory,Accumulator accumulator, InstructionRegister instructionRegister, InstructionCounter instructionCounter)
    {
    ...
    public void executeInstruction()
    {
        ...
        {
         //retrieve information from memory using the operand
            //and set it to the output
            setOutput(getMemory().getElement(getOperandRegister().getOperand()));
            //update the output stream with the output value
            getOutputStream().writeToGUI(getOutput());
        }
    }//end method   
    /**
