...
/**
 * This object performs a termination operation within an SML array
...
public class Halt extends Instructions{
  /**
     ...
     */
    public Halt(OperationCodeRegister opCode, OperandRegister operand,Memory memory,Accumulator accumulator, InstructionRegister instructionRegister, InstructionCounter instructionCounter)
    {
    ...
    public void executeInstruction()
    {
        ...
        {
         //print a termination message to the output stream            
            getOutputStream().writeToGUI(""+new simpletron.messages.Messages().terminationMessage);
