...
/**
* This object performs conditional branching if negative operations occur within a Simpletron array
* @see simpletron.instructions.Branch
* @see simpletron.instructions.BranchZero
* @author gerry dreamer
*/
public class BranchNeg extends Instructions{
     /**
     * the current constant defining this object
     */
    private final int constant = 41;
     /**
     ...
     */
    public BranchNeg(OperationCodeRegister opCode, OperandRegister operand,Memory memory,Accumulator accumulator, InstructionRegister instructionRegister, InstructionCounter instructionCounter)
    {
