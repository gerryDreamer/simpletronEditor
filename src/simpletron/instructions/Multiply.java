...
/**
 * This object performs multiplication operations within an SML array
...
public class Multiply extends Instructions{
     ...
     */
    public Multiply(OperationCodeRegister opCode, OperandRegister operand,Memory memory,Accumulator accumulator, InstructionRegister instructionRegister, InstructionCounter instructionCounter)
    {
    ...
    public void executeInstruction()
    {
        ...
        {
          //multiply a value from the location in memory specified in the operand into the accumulator
           try{
