...
/**
 * This object performs subtraction operations within an SML array
 * @author gerry dreamer
 */
public class Subtract extends Instructions{
     /**
     ...
     */
    public Subtract(OperationCodeRegister opCode, OperandRegister operand,Memory memory,Accumulator accumulator, InstructionRegister instructionRegister, InstructionCounter instructionCounter)
    {
    ...
    public void executeInstruction()
    {
        ...
        {
          //subtract a value from the location in memory specified in the operand into the accumulator
           try{
