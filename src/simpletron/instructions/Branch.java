...
/**
 * This object performs unconditional branching operations within a Simpletron array
 * @see simpletron.instructions.BranchNeg
 * @see simpletron.instructions.BranchZero
 * @author gerry dreamer
 */
public class Branch extends Instructions{
     /**
     * the current constant defining this object
     */
    public final int constant = 40;
     /**
     ...
     */
    public Branch(OperationCodeRegister opCode, OperandRegister operand,Memory memory,Accumulator accumulator, InstructionRegister instructionRegister, InstructionCounter instructionCounter)
    {
