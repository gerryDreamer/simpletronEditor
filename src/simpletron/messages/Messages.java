...
public class Messages {
     ...
     */
    public String welcomeMessage = "Welcome to Simpletron!" + "\nPlease enter your program one instruction" +
    ...
    /**
     * a string representation of the SML program termination message.
     */
    public String terminationMessage = "Program loading completed\n"+
     ...
     * @return a string representation of the current SML simulator memory dump
     */
       public String memoryDump(int[] memory, int accumulator, int instructionCounter, int instructionRegister, int operationCode, int operand)
       {
